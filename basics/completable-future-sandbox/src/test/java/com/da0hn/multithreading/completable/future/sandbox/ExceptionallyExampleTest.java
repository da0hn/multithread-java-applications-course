...
@DisplayName("Tests using exceptionally() method")
@ExtendWith(MockitoExtension.class)
class ExceptionallyExampleTest {
  ...
  void test1() {
    ...
    final var sut = new ExceptionallyExample(service);
  ...
  void test4() {
    ...
    final var sut = new ExceptionallyExample(new HelloWorldService());
